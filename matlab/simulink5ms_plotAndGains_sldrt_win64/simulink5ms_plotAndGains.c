...
void simulink5ms_plotAndGains_output(void)
{
   ...
   *  Gain: '<Root>/Gain3'
   */
  simulink5ms_plotAndGains_B.Gain = simulink5ms_plotAndGains_P.Gain3_Gain *
   ...
   *  Gain: '<Root>/Gain4'
   */
  simulink5ms_plotAndGains_B.Gain12 = simulink5ms_plotAndGains_P.Gain4_Gain *
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (3974620188U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (589282572U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (541332219U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (653056451U);
  ...
  simulink5ms_plotAndGains_M->Sizes.numBlocks = (38);/* Number of blocks */
  simulink5ms_plotAndGains_M->Sizes.numBlockIO = (14);/* Number of block outputs */
  simulink5ms_plotAndGains_M->Sizes.numBlockPrms = (34);/* Sum of parameter "widths" */

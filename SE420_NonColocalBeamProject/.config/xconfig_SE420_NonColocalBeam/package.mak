...
override PKGDIR = xconfig_SE420_NonColocalBeam
...
package/%.xdc.inc package/%_xconfig_SE420_NonColocalBeam.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_SE420_NonColocalBeam" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: SE420_NonColocalBeam.p28FP

-include package/cfg/SE420_NonColocalBeam_p28FP.mak
-include package/cfg/SE420_NonColocalBeam_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/SE420_NonColocalBeam_p28FP.dep
endif
SE420_NonColocalBeam.p28FP: package/cfg/SE420_NonColocalBeam_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
SE420_NonColocalBeam.p28FP package/cfg/SE420_NonColocalBeam_p28FP.c: .libraries,28FP
endif

package/cfg/SE420_NonColocalBeam_p28FP.c package/cfg/SE420_NonColocalBeam_p28FP.h package/cfg/SE420_NonColocalBeam_p28FP.xdl: override _PROG_NAME := SE420_NonColocalBeam.x28FP
package/cfg/SE420_NonColocalBeam_p28FP.c: package/cfg/SE420_NonColocalBeam_p28FP.cfg
package/cfg/SE420_NonColocalBeam_p28FP.xdc.inc: package/cfg/SE420_NonColocalBeam_p28FP.xdl
package/cfg/SE420_NonColocalBeam_p28FP.xdl package/cfg/SE420_NonColocalBeam_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/SE420_NonColocalBeam_p28FP.cfg
	-$(RM) package/cfg/SE420_NonColocalBeam_p28FP.dep
	-$(RM) package/cfg/SE420_NonColocalBeam_p28FP.c
	-$(RM) package/cfg/SE420_NonColocalBeam_p28FP.xdc.inc

clean,28FP::
	-$(RM) SE420_NonColocalBeam.p28FP
.executables,28FP .executables: SE420_NonColocalBeam.x28FP

SE420_NonColocalBeam.x28FP: |SE420_NonColocalBeam.p28FP

-include package/cfg/SE420_NonColocalBeam.x28FP.mak
SE420_NonColocalBeam.x28FP: package/cfg/SE420_NonColocalBeam_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/SE420_NonColocalBeam_p28FP.o28FP   package/cfg/SE420_NonColocalBeam_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
SE420_NonColocalBeam.x28FP: export C_DIR=
SE420_NonColocalBeam.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
SE420_NonColocalBeam.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

SE420_NonColocalBeam.test test,28FP test: SE420_NonColocalBeam.x28FP.test

SE420_NonColocalBeam.x28FP.test:: SE420_NonColocalBeam.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 SE420_NonColocalBeam.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.SE420_NonColocalBeam.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,SE420_NonColocalBeam.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) SE420_NonColocalBeam.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
SE420_NonColocalBeam_p28FP.o28FP,copy : package/cfg/SE420_NonColocalBeam_p28FP.o28FP
SE420_NonColocalBeam_p28FP.s28FP,copy : package/cfg/SE420_NonColocalBeam_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_SE420_NonColocalBeam
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_SE420_NonColocalBeam.tar.dep
endif
package/rel/xconfig_SE420_NonColocalBeam/xconfig_SE420_NonColocalBeam/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_SE420_NonColocalBeam/xconfig_SE420_NonColocalBeam/package/package.rel.xml: package/build.cfg
package/rel/xconfig_SE420_NonColocalBeam/xconfig_SE420_NonColocalBeam/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_SE420_NonColocalBeam/xconfig_SE420_NonColocalBeam/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_SE420_NonColocalBeam.tar: package/rel/xconfig_SE420_NonColocalBeam.xdc.inc package/rel/xconfig_SE420_NonColocalBeam/xconfig_SE420_NonColocalBeam/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_SE420_NonColocalBeam.xdc.inc,package/rel/xconfig_SE420_NonColocalBeam.tar.dep)


release release,xconfig_SE420_NonColocalBeam: all xconfig_SE420_NonColocalBeam.tar
clean:: .clean
	-$(RM) xconfig_SE420_NonColocalBeam.tar
	-$(RM) package/rel/xconfig_SE420_NonColocalBeam.xdc.inc
	-$(RM) package/rel/xconfig_SE420_NonColocalBeam.tar.dep
